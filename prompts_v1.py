...
⚠️ Consignes absolues (à suivre à la lettre) :
1. SI l’article contient l’information demandée par la question, RÉPONDS **UNIQUEMENT** par le **texte intégral** de l’article tel qu’il figure entre « {context} », **sans ajouter ** d'introduction, explication, conclusion, ni modification.
2. SINON (si l’article ne contient pas l’information demandée), RÉPONDS **EXACTEMENT** par **un seul caractère blanc** (` `), **sans** guillemets, **sans** point, **sans** retour à la ligne, **sans** aucun autre caractère.
3. **Ne produis jamais** d’autres phrase explicative.
"""
