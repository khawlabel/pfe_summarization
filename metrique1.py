...
# 1. Définir le modèle
llm = ChatGroq(groq_api_key=GROQ_API_KEY_3, model_name=LLM_NAME_1)
...
# 3. Créer un dataset avec HuggingFace Datasets
data = {
    "question": ["Quel est le contenu du document ?"],
    "contexts": [[context]],
...
# 4. Évaluer la pertinence avec RAGAS
result = evaluate(
    dataset=dataset,
...
#FactualCorrectness,LLMContextRecall lzm ykoun 3andek real summary 
# 5. Affichage
print(result)